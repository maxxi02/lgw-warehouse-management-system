// app/settings/components/AccountTab.tsx
"use client";
...
export default function AccountTab({ session }: { session: Session }) {
  ...
  const handlePasswordUpdate = async () => {
    ...
    try {
      ...
      // Handle better-auth specific error messages
  ...
  const handleNotificationSave = async () => {
    ...
    try {
      // Implement your notification settings save logic here
      // This could be an API call to save preferences
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
            <div className="flex items-start gap-2">
              <Bell className="h-4 w-4 text-green-600 dark:text-green-400 mt-0.5 flex-shrink-0" />
              <div className="space-y-1">
                <p className="text-sm font-medium text-green-800 dark:text-green-200">
                  Notification Settings
                </p>
                <p className="text-sm text-green-700 dark:text-green-300">
                  You can change these settings at any time. Important security
                  notifications will always be sent regardless of your
                  preferences.
                </p>
              </div>
            </div>
