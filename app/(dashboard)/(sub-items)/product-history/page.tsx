...
const ProductHistoryView = () => {
  ...
  useEffect(() => {
    fetchHistory();
    fetchStats();
    setUser({ role: "admin" }); // Mock user - replace with actual auth logic
  }, [fetchHistory]); // Changed from [currentPage] to [fetchHistory]

  // Update the second useEffect to include fetchHistory in dependencies:
  useEffect(() => {
    ...
    fetchHistory, // Added fetchHistory to dependencies
  ]);
  // Fetch statistics
                  ...
                  >
                    <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-start gap-3">
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-gray-600">
                              SKU: {item.productSku} • {item.category}
                            </p>
                            <div className="flex items-center gap-4 mt-2 text-sm text-gray-500">
                              ...
                              <span>Sold by: {item.soldBy.name}</span>
                            </div>
                            {item.notes && (
                      ...
                      <div className="text-right ml-4">
                        ...
                        <p className="text-sm text-gray-600">
                          {item.quantitySold} × {formatCurrency(item.unitPrice)}
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      <Dialog open={showClearDialog} onOpenChange={setShowClearDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              This will permanently delete all product sales history data. This
