  ...
  const getMarkerIcon = (location: MapLocation, isSelected: boolean) => {
    ...
    return new Icon({
      iconUrl:
        ...
        btoa(`
        <svg width="${isSelected ? "30" : "25"}" height="${isSelected ? "49" : "41"}" viewBox="0 0 ${isSelected ? "30" : "25"} ${isSelected ? "49" : "41"}" xmlns="http://www.w3.org/2000/svg">
          <path d="${isSelected ? "M15 0C6.716 0 0 6.716 0 15c0 15 15 34 15 34s15-19 15-34C30 6.716 23.284 0 15 0z" : "M12.5 0C5.596 0 0 5.596 0 12.5c0 12.5 12.5 28.5 12.5 28.5s12.5-16 12.5-28.5C25 5.596 19.404 0 12.5 0z"}" fill="${getColor()}"/>
          <circle cx="${isSelected ? "15" : "12.5"}" cy="${isSelected ? "15" : "12.5"}" r="${isSelected ? "6" : "5"}" fill="white"/>
        </svg>
      `),
