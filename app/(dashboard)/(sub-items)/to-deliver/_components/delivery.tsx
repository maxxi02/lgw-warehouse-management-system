    ...
    try {
      ...
      if (newStatus === "in-transit") {
        toast.success("Delivery Started", {
          description:
            "You can now proceed with the delivery. Remember to complete it before starting another one.",
        });
      } else if (newStatus === "delivered") {
        toast.success("Delivery Completed", {
          description: "Great job! You can now start new deliveries.",
        });
      } else {
